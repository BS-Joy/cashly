  ...
  return (
    <>
      <div className="flex items-center gap-2 text-xl">
        <FaAngleLeft />
        <h1 className="text-2xl">Add Subscription</h1>
      </div>
            ...
            <div className="flex justify-end pt-4">
              ...
              >
                ...
                <div className="flex gap-6 justify-between">
                  ...
                  <Form.Item
                    label={
                      <span className="font-medium text-xl font-lora">
                        Package Name
                      </span>
                    }
                    className="w-full"
                ...
                <div className="flex flex-col items-center gap-3 mt-16 mb-16">
                  <div className="flex justify-start w-full">
                    <label className="block font-medium text-xl font-lora mb-4 text-start">
                      Package Features
                    </label>
                  </div>
                ...
                <div className="w-full flex gap-5 justify-center ">
                  <RoundedButton className="">Add Subscription</RoundedButton>
                </div>
              </Form>
            </div>
          </div>
